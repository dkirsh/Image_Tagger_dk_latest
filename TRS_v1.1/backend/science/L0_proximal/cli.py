...
Usage:
    ...
    python -m science.L0_proximal.cli --image path/to/image.jpg

    # Single image with regional features (mock segmentation):
    python -m science.L0_proximal.cli --image path/to/image.jpg --regional --mock

    # Single image with regional features (real SegFormer):
    python -m science.L0_proximal.cli --image path/to/image.jpg --regional

    # Batch directory:
    python -m science.L0_proximal.cli --dir stimuli/ --output features.csv

    # Batch with regional features:
    python -m science.L0_proximal.cli --dir stimuli/ --regional --mock -o regional_features.csv

    # JSON output for single image:
    python -m science.L0_proximal.cli --image photo.jpg --format json --regional
"""
import argparse
import json
import logging
...
def _run_regional(args) -> None:
    ...
    from science.L0_proximal.regional import RegionalFeatureExtractor
