...
class RoomDetectionAnalyzer:
    ...
    provides = [
        "room.type_coarse",
        "room.type_coarse_confidence",
        "room.type_fine_confidence",
    ]

    _MODEL_VERSION = "places365_resnet50_v1"
    ...
    def analyze(
        ...
        """
        _MODEL_VERSION = RoomDetectionAnalyzer._MODEL_VERSION
        ...
        frame.add_structural("room.type_coarse", coarse_idx, model_version=_MODEL_VERSION, source="room_detection.RoomDetectionAnalyzer.analyze")
        frame.add_structural("room.type_coarse_confidence", float(top_coarse[1]), model_version=_MODEL_VERSION, source="room_detection.RoomDetectionAnalyzer.analyze")
        frame.add_structural("room.type_fine_confidence", float(top_fine[1]), model_version=_MODEL_VERSION, source="room_detection.RoomDetectionAnalyzer.analyze")
