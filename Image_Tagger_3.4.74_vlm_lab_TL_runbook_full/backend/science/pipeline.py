...
class SciencePipelineConfig:
    def __init__(self, enable_all: bool = True):
        ...
        # Instance segmentation (OneFormer) - opt-in for object detection
        self.enable_segmentation = False  # Semantic + instance segmentation with OneFormer
        # Segmentation modes (can enable both)
        self.segmentation_use_semantic = True  # Enable semantic segmentation (walls, floors, etc.)
        self.segmentation_use_panoptic = True  # Enable panoptic/instance segmentation (objects)
...
class SciencePipeline:
    def __init__(
        ...
        self.segmentation = SegmentationAnalyzer()  # OneFormer semantic + instance segmentation
